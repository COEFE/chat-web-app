-- Chart of Accounts Standardization (Fixed Version)
...
SELECT upsert_account('3010', 'Owner Equity', '3000', 'equity', 'Owner capital account');
...
-- Secondary Product/Service Revenue (4100-4199)
