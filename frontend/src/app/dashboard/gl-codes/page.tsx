                  ...
                  <div className="border rounded-md overflow-auto max-h-[500px]">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50 sticky top-0">
                        <tr>
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">GL Code</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Description</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Content</th>
                        </tr>
                      </thead>
                      <tbody className="bg-white divide-y divide-gray-200 text-gray-900">
                        {codes.map((code) => (
                          <tr key={code.id}>
                            <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-900">{code.gl_code}</td>
                            <td className="px-4 py-2 text-sm text-gray-900">{code.description}</td>
                            <td className="px-4 py-2 text-sm max-w-md truncate text-gray-900">{code.content}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
